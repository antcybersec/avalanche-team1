...
async function main() {
  console.log("Deploying MONDividendDistributor to Monad Mainnet...");
  ...
  console.log(`   npx hardhat verify --network monadMainnet ${contractAddress} "Zero-Man Company Token" "ZMC"`);
  console.log("2. Send MON to contract address to trigger dividend distribution");
  console.log("3. Token holders can call withdrawDividend() to claim their rewards");
  console.log("\n🚀 Monad Benefits:");
