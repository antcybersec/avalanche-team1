...
/// @title Monad MON Dividend Distributor
/// @notice Distributes 20% of incoming MON to token holders proportionally.
/// @dev 80% of the received funds go to the contract owner (main wallet).
contract MONDividendDistributor is ERC20, Ownable, ReentrancyGuard {
